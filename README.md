...
- Compare to Mustache.js, Hogan.js and Templayed.js [here](http://jsperf.com/template-mustachejs-hogan/4) and [here](http://jsperf.com/template-mustachejs-hogan/5)
